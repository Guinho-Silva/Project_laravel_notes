        ...
        <div class="col">
            ...
            <div class="row mt-5">
                <div class="col text-center">
                    ...
                    <a href="{{ route('cria_nota') }}" class="btn btn-secondary btn-lg p-3 px-5">
            ...
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('cria_nota') }}" class="btn btn-secondary px-3">
            ...
            <!-- Chama o conteúdo vindo do arquivo noteView -->
            @include('noteView')
